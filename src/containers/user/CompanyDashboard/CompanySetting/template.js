  ...
  elements: [
    ...
    },
    {
      ...
      request: async () => {
        ...
        return (result
          && result.data
          && result.data.languages.map(l => ({ label: l.value, value: l.name })));
      },
    },
    {
      ...
      request: async () => {
        ...
        return (result
          && result.data
          && result.data.currencies.map((l, index) => ({ label: l.name, value: l.value, index })));
      },
    },
    {
    ...
    },
    {
      ...
      request: async () => {
        ...
        return (result
          && result.data
          && result.data.items
          && result.data.items.map((l, index) => ({ label: l.name, value: l.id, index })));
      },
    },
    {
      type: 'select',

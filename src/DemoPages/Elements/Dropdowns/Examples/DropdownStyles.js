                          ...
                          <Col md="12">
                              <Card className="main-card mb-3">
                                  <CardBody>
                                      ...
                                      <Dropdown
className="d-inline-block" onMouseOver={this.onMouseEnter}
                              ...
                              <Card className="main-card mb-3">
                                  <CardBody>
                                      ...
                                      <UncontrolledButtonDropdown className="mb-2 mr-2">
                                          ...
                                          <DropdownToggle
outline className="dropdown-toggle-split" caret
                                              color="primary" />
                                          <DropdownMenu>
                                              <DropdownItem>Menus</DropdownItem>
                                              <DropdownItem>Settings</DropdownItem>
                                  ...
                                  <CardBody>
                                      ...
                                      <div className="text-center">
                                          <UncontrolledButtonDropdown direction="left" className="mb-2 mr-2">
                                              ...
                                              <DropdownToggle
className="dropdown-toggle-split" caret
                                                  color="primary" />
                                              <DropdownMenu>
                                                  <DropdownItem>Menus</DropdownItem>
                                                  <DropdownItem>Settings</DropdownItem>
                                  ...
                                  <CardBody>
                                      ...
                                      <div className="text-center">
                                          <UncontrolledButtonDropdown className="mb-2 mr-2">
                                              ...
                                              <DropdownToggle
size="lg" className="dropdown-toggle-split" caret
                                                  color="primary" />
                                              <DropdownMenu>
                                                  <DropdownItem>Menus</DropdownItem>
                                                  <DropdownItem>Settings</DropdownItem>
...
className="dropdown-toggle-split" caret
                                          ...
                                          <UncontrolledButtonDropdown className="mb-2 mr-2">
                                              ...
                                              <DropdownToggle
size="sm" className="dropdown-toggle-split" caret
                                                  color="primary" />
                                              <DropdownMenu>
                                                  <DropdownItem>Menus</DropdownItem>
                                                  <DropdownItem>Settings</DropdownItem>
...
size="sm" className="dropdown-toggle-split" caret
                                      ...
                                      <div className="text-center">
                                          <UncontrolledButtonDropdown>
                                              <DropdownToggle
className="btn-wide mb-2 mr-2" size="lg" caret
                                                  color="primary"
                                                >
                                                    Large
                                                </DropdownToggle>
                                          ...
                                          <UncontrolledButtonDropdown>
                                              <DropdownToggle
className="btn-wide mb-2 mr-2" size="sm" caret
                                                  color="primary"
                                                >
                                                    Small
                                                </DropdownToggle>

                ...
                <Card className="main-card mb-3">
                  <CardBody>
                    ...
                    <div className="text-center">
                      <ButtonGroup size="sm">
                        <Button
                            color="primary" onClick={() => this.onCheckboxBtnClick(1)}
                        ...
                        <Button
                            color="primary" onClick={() => this.onCheckboxBtnClick(3)}
                      ...
                      <ButtonGroup>
                        <Button
                            color="danger" onClick={() => this.onCheckboxBtnClick(1)}
                            active={this.state.cSelected.includes(1)}
                          >One
                          </Button>
                        <Button
                        ...
                        <Button
                            color="danger" onClick={() => this.onCheckboxBtnClick(3)}
                            active={this.state.cSelected.includes(3)}
                          >Three
                          </Button>
                      </ButtonGroup>
                      ...
                      <ButtonGroup size="lg">
                        <Button
                            color="alternate" onClick={() => this.onCheckboxBtnClick(1)}
                            active={this.state.cSelected.includes(1)}
                          >One
                          </Button>
                        <Button
                        ...
                        <Button
                            color="alternate" onClick={() => this.onCheckboxBtnClick(3)}
                            active={this.state.cSelected.includes(3)}
                          >Three
                          </Button>
                      </ButtonGroup>
                ...
                <Card className="main-card mb-3">
                  <CardBody>
                    ...
                    <div className="text-center">
                      ...
                      <ButtonGroup>
                        <Button
                            color="warning" onClick={() => this.onRadioBtnClick(1)}
                            active={this.state.rSelected === 1}
                          >One
                          </Button>
                        <Button
                            color="warning" onClick={() => this.onRadioBtnClick(2)}
                            active={this.state.rSelected === 2}
                          >Two
                          </Button>
                        <Button
                            color="warning" onClick={() => this.onRadioBtnClick(3)}
                            active={this.state.rSelected === 3}
                          >Three
                          </Button>
                      </ButtonGroup>
                      ...
                      <ButtonGroup size="lg">
                        <Button
                            color="focus" onClick={() => this.onRadioBtnClick(1)}
                            active={this.state.rSelected === 1}
                          >One
                          </Button>
                        <Button
                        ...
                        <Button
                            color="focus" onClick={() => this.onRadioBtnClick(3)}
                            active={this.state.rSelected === 3}
                          >Three
                          </Button>
                      </ButtonGroup>

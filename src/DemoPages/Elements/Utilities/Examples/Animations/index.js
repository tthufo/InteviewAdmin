...
All Animate.css animations are available if enabled from the
                <b>/assets/utils/_animate.css</b>
                {' '}
file.
              </p>

              <div className="text-center">
                <Animated animationIn="lightSpeedIn" animationOut="lightSpeedOut" isVisible>
        ...
        <Col lg="6">
          <Card className="main-card mb-3">
            <CardBody>
              ...
              <Anime opacity={[0, 1]} translateY="1.5em" delay={(e, i) => i * 1000} loop>
                <p>

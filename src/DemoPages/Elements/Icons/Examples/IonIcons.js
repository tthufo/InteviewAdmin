                ...
                <Row>
                  <Col md="2">
                    <div className="font-icon-wrapper">
                        <Ionicon icon="ios-refresh" fontSize="60px" color="#347eff" rotate />
                        <p>rotate=true</p>
                      </div>
                  </Col>
                  <Col md="2">
                    <div className="font-icon-wrapper">
                        <Ionicon icon="md-pizza" shake fontSize="60px" color="orange" />
                        <p>shake=true</p>
                      </div>
                  </Col>
                  <Col md="2">
                    <div className="font-icon-wrapper">
                        <Ionicon icon="md-heart" fontSize="60px" color="red" beat />
                        <p>beat=true</p>
                      </div>
                  </Col>
                  <Col md="2">
                    <div className="font-icon-wrapper">
                        <Ionicon icon="md-infinite" fontSize="60px" color="#333" rotate />
                        <p>rotate=true</p>
                      </div>
                  </Col>
                  <Col md="2">
                    <div className="font-icon-wrapper">
                        <Ionicon
                            icon="logo-nodejs" onClick={() => alert('Hi!')} fontSize="60px"
                            color="#43853d"
                          />
                        <p>onClick event</p>
                      </div>

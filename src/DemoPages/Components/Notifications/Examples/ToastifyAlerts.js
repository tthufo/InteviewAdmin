...
const Radio = ({
  options, name, onChange, checked = false,
...
class ToastifyAlerts extends Component {
    ...
    showToast = () => (this.state.type === 'default'
    ...
    handleAutoCloseDelay = e => this.setState({
    ...
    handleRadioOrSelect = e => this.setState({
      [e.target.name]: e.target.value,
    });

    toggleCheckbox = e => this.setState({
...
Clear
                      ...
                      <Button
                        size="sm" className="text-primary" onClick={this.handleReset}
                        color="link"
                      >Reset
                      </Button>
                    </div>

...
stop={10}
                    emptySymbol={(
                      <span className="opacity-3">
                            <Ionicon color="#3f6ad8" fontSize="2rem" icon="ios-film" beat />
                          </span>
)}
                    fullSymbol={(
                      <span>
...
stop={10}
                    emptySymbol={(
                      <span className="opacity-5">
                            <Ionicon color="#4eaf07" fontSize="2.2rem" icon="ios-star" rotate />
                          </span>
)}
                    fullSymbol={(
                      <span>

...
export default class Mailbox extends Component {
  constructor() {
    ...
    const exampleItems = [...Array(30).keys()].map(i => ({ id: (i + 1), name: `Item ${i + 1}` }));
...
Manage all of your
                    ...
                    <div className="bg-white">
                      ...
                      <div className="app-inner-layout__bottom-pane d-block text-center">
                            <JwPagination
                                pageSize={5} items={this.state.exampleItems}

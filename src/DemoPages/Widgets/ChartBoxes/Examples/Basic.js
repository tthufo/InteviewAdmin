                ...
                <div className="card mb-3 widget-chart">
                  <div className="icon-wrapper rounded">
                    ...
                    <div className="center-svg">
                      <Ionicon
                            color="#333333" fontSize="2rem" icon="ios-car-outline"
                            beat
                          />
                    </div>
                  </div>
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  <div className="icon-wrapper rounded">
                    <div className="icon-wrapper-bg bg-primary" />
                    <div className="center-svg">
                      <Ionicon color="#3f6ad8" fontSize="2rem" icon="ios-film" shake />
                    </div>
                  </div>
                  <div className="widget-numbers">
                    <CountUp
            ...
            <Row>
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  ...
                  <div className="widget-progress-wrapper">
                    <Progress
                      className="progress-bar-sm progress-bar-animated-alt" color="success"
                      value="65"
                    />
                  </div>
                </div>
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  ...
                  <div className="widget-progress-wrapper">
                    <Progress
                      className="progress-bar-xs progress-bar-animated-alt" color="danger"
                      value="85"
                    />
                  </div>
                </div>
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  ...
                  <div className="widget-progress-wrapper">
                    <Progress
                      className="progress-bar-lg progress-bar-animated" color="primary"
                      value="65"
                    />
                  </div>
                </div>
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart">
                  ...
                  <div className="widget-progress-wrapper">
                    <Progress
                      className="progress-bar-xs progress-bar-animated" color="info"
                      value="85"
                    />
                  </div>
                </div>

                ...
                <Card className="mb-3">
                  <CardHeader className="h-auto p-3">
                    ...
                    <div className="btn-actions-pane-right">
                      <UncontrolledButtonDropdown>
                            <DropdownToggle
                                caret size="sm" className="btn-icon btn-icon-only"
                                color="dark"
                              >
                                ...
                                <ResponsiveContainer height={250}>
                                    <AreaChart
                                      ...
                                      >
                                        ...
                                        <defs>
                                            <linearGradient
                                                id="colorUv" x1="0" y1="0" x2="0"
                                                y2="1"
                                              >
                                                <stop
                                                    offset="5%" stopColor="#f5d7ea"
                                                    stopOpacity={0}
                                                  />
                                                <stop
                                                    offset="95%" stopColor="#f5d7ea"
                                                    stopOpacity={0.8}
                                                  />
                                              </linearGradient>
                                          </defs>
                                        <Tooltip />
                                        <Area
                                            type="monotone" dataKey="uv" stroke="#e570b9"
...
Live
                    ...
                    <div className="btn-actions-pane-right">
                      <Button
                            size="sm" onClick={this.togglePop} id="PopoverEx1"
                      ...
                      <Popover
                            className="popover-custom" placement="bottom-start"
...
Recover
                                    ...
                                    <NavItem className="nav-item-btn">
                                        <Button
                                            size="sm" className="btn-wide btn-shadow"
                                            color="danger"
                                          >
                                                                Cancel
                                          </Button>
                      ...
                      <TabPane tabId="1">
                            ...
                            <ResponsiveContainer height={210}>
                                <BarChart data={data2}>
                                    ...
                                    <Legend />
                                    <Bar
                                        barGap="12" dataKey="Sales" stackId="a"
                                        fill="#3f6ad8"
                                      />
                                    <Bar
                                        barGap="12" dataKey="Downloads" stackId="a"
                                        fill="#e0f3ff"
                                      />
                                  </BarChart>
                              </ResponsiveContainer>
                ...
                <Card className="mb-3">
                  <CardHeader className="h-auto p-3">
                    ...
                    <div className="btn-actions-pane-right">
                      <UncontrolledButtonDropdown>
                            <DropdownToggle
                                size="sm" caret className="btn-icon btn-icon-only"
                                color="dark"
                              >
                                <div className="btn-icon-wrapper">
                                    <FontAwesomeIcon icon={faBars} />
                                    ...
                                    <div className="svg-bg">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 288 288">
                                            <path fill="#333333">
                                                ...
                                                <animate
                                                    repeatCount="indefinite" attributeName="d" dur="5s"
                            ...
                            <div className="chart-wrapper">
                                <ResponsiveContainer height={250}>
                                    <BarChart data={data222}>
                                        <Bar
                                            barGap="55" dataKey="Sales" stackId="a"
                                            fill="#58a90f"
                                          />
                                        <Bar
                                            barGap="55" dataKey="Downloads" stackId="a"
                                            fill="#ecffda"
                                          />
                                      </BarChart>
                                  </ResponsiveContainer>
                      ...
                      <ResponsiveContainer width="100%" aspect={3.0 / 1.0}>
                            <LineChart
                              ...
                              >
                                <Tooltip />
                                <Line
                                    type="monotone" dataKey="pv" stroke="#d6b5ff"
                                    strokeWidth={2}
                                  />
                                <Line
                                    type="monotone" dataKey="uv" stroke="#a75fff"
                                    strokeWidth={2}
                                  />
                              </LineChart>
                          </ResponsiveContainer>
...
Manage all of your
                            ...
                            <div className="menu-header-btn-pane">
                                ...
                                <Button
                                    size="sm" className="btn-icon btn-icon-only"
                                    color="danger"
                                  >
                                    <i className="pe-7s-config btn-icon-wrapper"> </i>
                                  </Button>
                                    ...
                                    <Col md="5" className="align-self-center">
                                        <div>
                                            ...
                                            <div className="text-center mt-3">
                                                <Button
                                                    outline className="border-0 btn-transition"
                                                    color="danger"
                                                  >Remove
                                                  </Button>
                                                <Button

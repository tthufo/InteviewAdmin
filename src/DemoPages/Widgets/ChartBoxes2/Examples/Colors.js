                    ...
                    <div className="widget-chart-wrapper">
                      <ResponsiveContainer height="100%">
                            <LineChart
                              ...
                              >
                                <Line
                                    type="monotone" dataKey="pv" stroke="rgba(255,255,255,.3)"
                                    strokeWidth={3}
                                  />
                              </LineChart>
                          </ResponsiveContainer>
                    ...
                    <div className="widget-chart-wrapper">
                      <ResponsiveContainer height="100%">
                            <AreaChart
                              ...
                              >
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="rgba(255,255,255,.5)"
                    ...
                    <div className="widget-chart-wrapper">
                      <ResponsiveContainer height="100%">
                            <BarChart
                              ...
                              >
                                <Bar
                                    dataKey="uv" fill="rgba(255,255,255,.5)"
                    ...
                    <div className="widget-chart-wrapper">
                      <ResponsiveContainer height="100%">
                            <AreaChart
                              ...
                              >
                                <Area
                                    type="stepAfter" dataKey="uv" stroke="rgba(255,255,255,.6)"

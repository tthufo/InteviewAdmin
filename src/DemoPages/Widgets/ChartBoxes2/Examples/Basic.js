                    ...
                    <div className="widget-chart-wrapper">
                      <ResponsiveContainer height="100%">
                            <LineChart
                              ...
                              >
                                <Line
                                    type="monotone" dataKey="pv" stroke="#3ac47d"
                                    strokeWidth={3}
                                  />
                              </LineChart>
                          </ResponsiveContainer>
                    ...
                    <div className="widget-chart-wrapper">
                      <ResponsiveContainer height="100%">
                            <AreaChart
                              ...
                              >
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="#fd7e14"
                                    fill="#ffb87d"
                                  />
                              </AreaChart>
                          </ResponsiveContainer>
                    ...
                    <div className="widget-chart-wrapper">
                      <ResponsiveContainer height="100%">
                            <AreaChart
                              ...
                              >
                                <Area
                                    type="stepAfter" dataKey="uv" stroke="#3aabff"
                                    fill="#78C3FB"
                                  />
                              </AreaChart>
                          </ResponsiveContainer>
                    ...
                    <div className="widget-chart-wrapper">
                      <ResponsiveContainer width="100%">
                            <ComposedChart data={data2}>
                                ...
                                <Area
                                    type="monotone" dataKey="amt" fill="#f7ffd0"
                                    stroke="#85a200"
                                  />
                    ...
                    <div className="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0">
                      <ResponsiveContainer height="100%">
                            <AreaChart
                              ...
                              >
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="#e570b9" strokeWidth="4"
                                    fill="#f5d7ea"
                                  />
                              </AreaChart>
                          </ResponsiveContainer>
                    ...
                    <div className="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0">
                      <ResponsiveContainer height="100%">
                            <AreaChart
                              ...
                              >
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="#9ce570" strokeWidth="4"
                                    fill="#ddf5d7"
                                  />
                              </AreaChart>
                          </ResponsiveContainer>
                    ...
                    <div className="widget-chart-wrapper widget-chart-wrapper-lg opacity-10 m-0">
                      <ResponsiveContainer height="100%">
                            <AreaChart
                              ...
                              >
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="#1e4bf2" strokeWidth="4"
                                    fill="#ccddf9"
                                  />
                              </AreaChart>
                          </ResponsiveContainer>
                      ...
                      <ResponsiveContainer height="100%">
                            <LineChart
                              ...
                              >
                                <Tooltip />
                                <Line
                                    type="monotone" dataKey="pv" stroke="#1eb1f2"
                                    strokeWidth={3}
                                  />
                              </LineChart>
                          </ResponsiveContainer>
                      ...
                      <ResponsiveContainer height="100%">
                            <AreaChart
                              ...
                              >
                                <Tooltip />
                                <Area
                                    type="monotoneX" dataKey="uv" strokeWidth={0}
                                    fill="#bdadd8"
                                  />
                              </AreaChart>
                          </ResponsiveContainer>
                    ...
                    <div className="widget-chart-wrapper">
                      <ResponsiveContainer height="100%">
                            <LineChart
                              ...
                              >
                                <Line
                                    type="monotone" dataKey="pv" stroke="#bac601"
                                    strokeWidth={3}
                                  />
                              </LineChart>
                          </ResponsiveContainer>
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart widget-chart2 text-left">
                  <div className="widget-chat-wrapper-outer">
                    ...
                    <div className="widget-progress-wrapper">
                      <Progress
                            className="progress-bar-sm progress-bar-animated" color="warning"
                            value="47"
                          />
              ...
              <Col md="4">
                <div className="card mb-3 widget-chart widget-chart2 text-left">
                  <div className="widget-chat-wrapper-outer">
                    ...
                    <div className="widget-progress-wrapper">
                      <Progress
                            className="progress-bar" animated color="success"
                            value="47"
                          />
                      <div className="progress-sub-label">Successful Payments</div>
                    </div>

                                    ...
                                    <ResponsiveContainer height="100%">
                                        <BarChart data={data222}>
                                            <Bar
                                              ...
                                              />
                                            <Bar
                                                barGap="12" dataKey="Downloads" fillOpacity=".2"
                                                stackId="a"
                                                fill="var(--primary)"
                                              />
                                          </BarChart>
              ...
              <Table responsive hover striped borderless className="align-middle mb-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-center">
                      <Button
                        size="sm" className="btn-icon btn-icon-only" color="light"
                        id="PopoverCustomT-1"
                ...
                <div className="card mb-3 widget-chart bg-arielle-smile card-border">
                  ...
                  <div className="widget-chart-wrapper chart-wrapper-relative">
                    <ResponsiveContainer width="100%" height={174}>
                      ...
                      >
                        <Area
                            type="stepAfter" dataKey="uv" stroke="rgba(255,255,255,.7)"
                  ...
                  <div className="widget-chart-wrapper chart-wrapper-relative">
                    <ResponsiveContainer width="100%" height={146}>
                      ...
                      >
                        ...
                        <Line
                            type="monotone" dataKey="uv" stroke="rgba(255,255,255,.7)"
                            strokeWidth={2}
                          />
                        <Tooltip />
                      </LineChart>

                              ...
                              >
                                <defs>
                                    <linearGradient id="colorPv2" x1="0" y1="0" x2="0" y2="1">
                                        <stop
                                            offset="10%" stopColor="var(--warning)"
                                            stopOpacity={0.7}
                                          />
                                        <stop
                                            offset="90%" stopColor="var(--warning)"
                                            stopOpacity={0}
                                          />
                                      </linearGradient>
                                  </defs>
                                <Tooltip />
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="var(--warning)"
                            ...
                            <AreaChart
                              ...
                              >
                                <defs>
                                    <linearGradient id="colorPv2" x1="0" y1="0" x2="0" y2="1">
                                        <stop
                                            offset="10%" stopColor="var(--alternate)"
                                            stopOpacity={0.7}
                                          />
                                        <stop
                                            offset="90%" stopColor="var(--alternate)"
                                            stopOpacity={0}
                                          />
                                      </linearGradient>
                                  </defs>
                                <Tooltip />
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="var(--alternate)"
                                    strokeWidth={2} fillOpacity={1}
                                    fill="url(#colorPv2)"
                                  />
                              </AreaChart>
                      ...
                      <ResponsiveContainer height={131}>
                            <AreaChart
                              ...
                              >
                                <Tooltip />
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="var(--success)"
                      ...
                      <ResponsiveContainer height={131}>
                            <AreaChart
                              ...
                              >
                                <Tooltip />
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="var(--danger)"
                      ...
                      <ResponsiveContainer height={131}>
                            <AreaChart
                              ...
                              >
                                <Tooltip />
                                <Area
                                    type="monotoneX" dataKey="uv" stroke="rgba(255,255,255,.3)"
                ...
                <Table responsive hover striped borderless className="align-middle mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-center">
                            <Button
                                size="sm" color="primary" id="PopoverCustomT-1"
                                onClick={this.togglePop1}
                              >
                                                Details
                              </Button>
                            <Popover
                                className="popover-custom rm-pointers" placement="auto"
...
Recover
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                            <Button
                                size="sm" color="primary" id="PopoverCustomT-2"
...
Recover
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                            <Button
                                size="sm" color="primary" id="PopoverCustomT-3"
...
Recover
                    ...
                    <tr>
                      ...
                      <td className="text-center">
                            <Button
                                size="sm" color="primary" id="PopoverCustomT-4"

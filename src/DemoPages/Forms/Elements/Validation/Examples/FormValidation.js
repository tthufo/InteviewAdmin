...
import {
  AvForm, AvField, AvGroup, AvInput, AvFeedback, AvRadioGroup, AvRadio,
                ...
                <AvForm>
                  <Row>
                    <Col md="6">
                      ...
                      {/* Radios */}
                      <AvRadioGroup
                            name="radioExample" label="Radio Buttons!" required
                      ...
                      <AvRadioGroup
                            inline name="radioExample2" label="Radio Buttons! (inline)"
                            required
                          >
                            <AvRadio label="Bulbasaur" value="Bulbasaur" />
                            <AvRadio label="Squirtle" value="Squirtle" />
                      ...
                      <AvRadioGroup
                            name="radioCustomInputExample" label="Custom Radio Buttons!"
                            required
                          >
                      ...
                      <AvRadioGroup
                            inline name="radioCustomInputExample2"
                    ...
                    <Col md="6">
                      ...
                      <AvField
                            type="select" name="select" label="Option"
                      ...
                      <AvField
                            type="select" name="select-multiple" label="Option"
                      ...
                      <FormGroup>
                            ...
                            <AvField
                                type="checkbox" name="avFieldCheckbox"
                                label="Check out this AvField checkbox"
                                required
                              />

                            <AvInput
                                tag={CustomInput} type="checkbox" name="customCheckbox"
                                label="Check out this custom input checkbox" required
                              />

                            <AvField
                                tag={CustomInput} type="checkbox" name="customCheckbox1"

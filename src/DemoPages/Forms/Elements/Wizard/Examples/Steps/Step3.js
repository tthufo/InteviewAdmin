                  ...
                  <Row form>
                    <Col md={6}>
                      <FormGroup>
                            ...
                            <Input
                                type="email" name="email" id="exampleEmail2"
              ...
              >
                <CardBody>
                  ...
                  <FormGroup>
                    ...
                    <Input
                      type="email" name="email" id="exampleEmail4"
                      placeholder="with a placeholder"
                    />
                  </FormGroup>
                  <FormGroup>
                  ...
                  <FormGroup>
                    ...
                    <Input
                      type="number" name="number" id="exampleNumber"
                  ...
                  <FormGroup>
                    ...
                    <Input
                      type="datetime" name="datetime" id="exampleDatetime"
                  ...
                  <FormGroup>
                    ...
                    <Input
                      type="color" name="color" id="exampleColor"

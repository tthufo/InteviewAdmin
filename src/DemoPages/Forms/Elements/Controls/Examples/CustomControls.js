              ...
              <Card className="main-card mb-3">
                <CardBody>
                  ...
                  <FormGroup>
                    <div>
                      <CustomInput
                            type="checkbox" id="exampleCustomCheckbox"
                  ...
                  <FormGroup>
                    <div>
                      ...
                      <CustomInput
                          ...
                          />
                      <CustomInput
                            type="radio" id="exampleCustomRadio3"
                            label="But not this disabled one"
                            disabled
                          />
                    </div>
                  ...
                  <Row>
                    <Col md="6">
                      <FormGroup>
                            ...
                            <CustomInput
                                type="select" id="exampleCustomSelect"
                                name="customSelect"
                              >
...
Custom Multiple
                            ...
                            <CustomInput
                                type="select" id="exampleCustomMutlipleSelect"
                                name="customSelect"
                                multiple
                              >
                                <option value="">Select</option>
...
Custom Select
                            ...
                            <CustomInput
                                type="select" id="exampleCustomSelectDisabled"
                                name="customSelect"
                                disabled
                              >
                                <option value="">Select</option>

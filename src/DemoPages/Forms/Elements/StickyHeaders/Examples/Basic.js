        ...
        >
          <div>
            <Card className="main-card mb-3">
              <Sticky enabled top=".app-header" innerZ="15" activeClass="sticky-active-class">
                <CardHeader className="card-header-lg">
                  ...
                  <div className="btn-actions-pane-right">
                    <Button
                      size="lg" color="warning" className="mr-2"
                      onClick={this.toggleCalendar}
                    >
                      <span className="mr-2 opacity-8">
                            <Ionicon
                                color="#333333" fontSize="1.2rem"
                                icon="ios-analytics-outline" shake
                              />
                          </span>
                                            Dummy Button
                    </Button>
                    ...
                    <UncontrolledButtonDropdown>
                      ...
                      <DropdownToggle
                            className="dropdown-toggle-split" caret size="lg"
                            color="primary"
                          />
                      <DropdownMenu right>
              ...
              <CardBody className="pt-4">
                <Col md="8" className="mx-auto">
                  ...
                  <FormGroup>
                    ...
                    <Input
                      type="text" name="address" id="exampleAddress"
                  ...
                  <FormGroup>
                    ...
                    <Input
                      type="text" name="address2" id="exampleAddress2"
                  ...
                  <FormGroup>
                    ...
                    <div>
                      ...
                      <CustomInput
                            type="checkbox" id="exampleCustomCheckbox3" label="But not this disabled one"
                            disabled
                          />
                    </div>
                  </FormGroup>
                  <FormGroup>
                    ...
                    <div>
                      ...
                      <CustomInput
                            type="radio" id="exampleCustomRadio3" label="But not this disabled one"
                            disabled
                          />
                    </div>
                  </FormGroup>
                  <FormGroup>
                    ...
                    <div>
                      <CustomInput
                            type="checkbox" id="exampleCustomInline" label="An inline custom input"
                            inline
                          />
                  ...
                  <FormGroup>
                    ...
                    <CustomInput
                      type="select" id="exampleCustomMutlipleSelectDisabled" name="customSelect" multiple
                      disabled
                    >
                      <option value="">Select</option>
                      <option>Value 1</option>
